...
packer.startup(function(use)
    ...
    use({ "folke/zen-mode.nvim", cmd = "ZenMode", config = get_config("zen-mode") }) -- zen mode
    use({ "folke/twilight.nvim", config = get_config("twilight") }) -- highlights part of code being worked on in zen mode
