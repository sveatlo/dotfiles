		...
		dependencies = {
			...
			config = function()
				if vim.fn.has("win32") == 1 then
					require("dap-python").setup(lsp_utils.get_pkg_path("debugpy", "/venv/Scripts/pythonw.exe"))
				else
					require("dap-python").setup(lsp_utils.get_pkg_path("debugpy", "/venv/bin/python"))
				end
			end,
		},
	},
