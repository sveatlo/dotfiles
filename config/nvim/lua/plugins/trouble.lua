-- configuration for the trouble.nvim plugin
...
wk.register({
  x = {
    ...
    w = { "<cmd>Trouble workspace_diagnostics<cr>", "Show workspace diagnosticts" },
    d = { "<cmd>Trouble document_diagnostics<cr>", "Show document diagnostics" },
    l = { "<cmd>Trouble loclist<cr>", "Show location list" },
