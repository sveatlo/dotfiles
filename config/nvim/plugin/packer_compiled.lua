...
_G.packer_plugins = {
  ...
  ["cmp-nvim-ultisnips"] = {
    loaded = true,
    path = "/home/sveatlo/.local/share/nvim/site/pack/packer/start/cmp-nvim-ultisnips",
  ...
  ["lualine.nvim"] = {
    loaded = true,
    path = "/home/sveatlo/.local/share/nvim/site/pack/packer/start/lualine.nvim",
  ...
  ultisnips = {
    loaded = true,
    path = "/home/sveatlo/.local/share/nvim/site/pack/packer/start/ultisnips",
    url = "https://github.com/SirVer/ultisnips"
  },
  ["vim-abolish"] = {
    loaded = true,
    path = "/home/sveatlo/.local/share/nvim/site/pack/packer/start/vim-abolish",
